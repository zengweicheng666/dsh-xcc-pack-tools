  ...
  factory: (require) => {
    ...
    function PackPanel(props) {
      ...
      function ReleaseView() {
        ...
        var overviewBusy = isJobRunning("overview");
        ...
        return h("div", {},
          h("div", { className: "dsh-pack-card" },
            ...
            h("div", { className: "dsh-pack-row" },
              ...
              h("input", { className: "dsh-pack-input", disabled: !root || busy || overviewBusy || projectNameBusy,
              ...
              h("button", { className: "dsh-pack-mini", disabled: !root || busy || overviewBusy || projectNameBusy,
