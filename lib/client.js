    ...
    function PackPanel(props) {
      ...
      function renderTaskLog(kind, name) {
        ...
        return h("div", { className: "dsh-pack-task" },
          h("div", { className: "dsh-pack-loghead" }, name, h("button", { className: "dsh-pack-mini", style: { marginLeft: "auto" }, onClick: function () { clearLog(kind); } }, "清空日志")),
          ...
          h("div", { ref: logRef, className: "dsh-pack-log", style: { height: (taskLogHeights[kind] || 180) + "px" } }, lines.length ? lines.join("\n") : "暂无任务日志"));
      }
