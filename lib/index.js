...
import { decodeLine, localDateStamp, scanReleases, computeReleaseName, parseReleaseName, normalizeReleasePrefix, RELEASE_PREFIX, parseWebVersion, bumpWebVersion, versionText, resolveRemotePath, parseUproject, isVersionAssociation, ueVersionKey, parseLauncherInstalled } from './pure.js';
...
function buildApi(ctx) {
  ...
  api.releaseStart = async (p) => {
    ...
    (async () => {
      try {
        ...
        if (!doZip) {
          ...
          job.result = { dir: dst, name: info.name, zip: undefined, sourceDir: src, sourceExecutable: srcInfo.executable, executable: releaseExecutable };
        ...
        job.result = { dir: dst, zip: zipPath, name: info.name, zipTool, sourceDir: src, sourceExecutable: srcInfo.executable, executable: releaseExecutable };
    ...
    return { jobId: job.jobId, kind: 'release', name: info.name, dir: dst, zip: doZip ? zipPath : undefined, zipTool, sourceDir: src, sourceExecutable: srcInfo.executable, executable: releaseExecutable };
  };
